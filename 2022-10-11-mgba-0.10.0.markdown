...
mGBA 0.10.0 adds support for this GBX format, though not all mappers defined in the GBX specification are currently supported. More will be [coming in future releases](https://mgba.io/i/2437).
